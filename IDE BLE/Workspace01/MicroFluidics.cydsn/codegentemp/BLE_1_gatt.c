    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'B', (uint8)'i', (uint8)'o', (uint8)'S', (uint8)'e', (uint8)'n', (uint8)'s', (uint8)'e', 
    ...
    (uint8)'b', (uint8)'i', (uint8)'o', (uint8)'s', (uint8)'e', (uint8)'n', (uint8)'s', (uint8)'e', (uint8)' ', (uint8)'u',
...
const uint8 cyBle_attUuid128[][16u] = {
    /* BioSensor */
    { 0xF0u, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xB5u, 0xCAu, 0x00u, 0x00u },
    /* Sensor */
    { 0xF1u, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xA2u, 0xCAu, 0x00u, 0x00u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* BioSensor UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Sensor UUID */
    { 0x0002u, (void *)&cyBle_attValues[23] }, /* Sensor */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x12u] = {
    ...
    { 0x000Fu, 0x2803u /* Characteristic                      */, 0x00001201u /* rd,ntf */, 0x0012u, {{0x0010u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0010u, 0xCAA2u /* Sensor                              */, 0x00091201u /* rd,ntf */, 0x0012u, {{0x0002u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0011u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd     */, 0x0011u, {{0x000Fu, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0012u, 0x2902u /* CCCD                                */, 0x00010A04u /* rd,wr  */, 0x0012u, {{0x0002u, (void *)&cyBle_attValuesLen[10]}} },
};
