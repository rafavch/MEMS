...
#define CYBLE_BIOSENSOR_SERVICE_INDEX   (0x00u) /* Index of BioSensor service in the cyBle_customs array */
#define CYBLE_BIOSENSOR_SENSOR_CHAR_INDEX   (0x00u) /* Index of Sensor characteristic */
#define CYBLE_BIOSENSOR_SENSOR_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_BIOSENSOR_SENSOR_CCCD_DESC_INDEX   (0x01u) /* Index of CCCD descriptor */


#define CYBLE_BIOSENSOR_SERVICE_HANDLE   (0x000Eu) /* Handle of BioSensor service */
#define CYBLE_BIOSENSOR_SENSOR_DECL_HANDLE   (0x000Fu) /* Handle of Sensor characteristic declaration */
#define CYBLE_BIOSENSOR_SENSOR_CHAR_HANDLE   (0x0010u) /* Handle of Sensor characteristic */
#define CYBLE_BIOSENSOR_SENSOR_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0011u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_BIOSENSOR_SENSOR_CCCD_DESC_HANDLE   (0x0012u) /* Handle of CCCD descriptor */
