...
const CYBLE_GLSS_T cyBle_glss =
{
    0x000Eu,    /* Handle of the GLS service */
    {
        
        /* Glucose Measurement characteristic */
        {
            0x0010u, /* Handle of the Glucose Measurement characteristic */ 
            0x0011u, /* Handle of the Client Characteristic Configuration descriptor */ 
        }, 
        
        /* Glucose Measurement Context characteristic */
        {
            0x0013u, /* Handle of the Glucose Measurement Context characteristic */ 
            0x0014u, /* Handle of the Client Characteristic Configuration descriptor */ 
        }, 
        
        /* Glucose Feature characteristic */
        {
            0x0016u, /* Handle of the Glucose Feature characteristic */ 
            CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, 
        }, 
        
        /* Record Access Control Point characteristic */
        {
            0x0018u, /* Handle of the Record Access Control Point characteristic */ 
